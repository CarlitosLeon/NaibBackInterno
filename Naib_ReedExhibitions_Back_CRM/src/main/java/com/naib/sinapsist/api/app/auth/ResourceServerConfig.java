...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
                        ...
                        .antMatchers(HttpMethod.POST,"/ventasProspectos/crmSaveExpositor/{idU}/{idEv}/{expositor}").permitAll()
                        .antMatchers(HttpMethod.GET,"/calendar/calendario/calendarTask/**","/images/**").permitAll()
